module FsSnip.Recommender.Stemmer
// Downloaded from http://fssnip.net/eR
...
let stem (s:string) = System.String(s.ToLower().ToCharArray() |> Array.toList |> stemCs |> List.toArray) |> string
